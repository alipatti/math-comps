...
\begin{frame}
	...
	\begin{itemize}
		\item<3-> Any integer is an algebraic integer
		\item<4-> $i \sqrt 5 \in \mathbb A$ because of $f(x) = x^2$
		\item<5-> $2 + \sqrt[3]{17} \in \mathbb A$ because of $f(x) = x^3 - 6 x^2 + 12 x - 25$
		\item<6-> $\mathbb A$ is a subring of $\C$
